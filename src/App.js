...
import Hook_useReducer from "./components/Hook_Reducer";
import Hook_Checkbox from "./components/Hook_Checkbox";
    ...
    <Router>
      <div>
        <nav>
          ...
          <br />
          <Link className="navItem" to={"/hoc"}>
            Higher Order Component
          </Link>
          <br />
          <Link className="navItem" to={"/hoc2"}>
            Higher Order Commponent 2
          </Link>
          <br />
          <Link className="navItem" to={"/hook"}>
            Hook [useSate&useEffect]
          </Link>
          <br />
          <Link className="navItem" to={"/hook2"}>
            Hook[chekcbox]
          </Link>
          <br />
          <Link className="navItem" to={"/customhook"}>
            Custom Hook
          </Link>
          <br />
          <Link className="navItem" to={"/context"}>
            Context
          </Link>
          <br />
          <Link className="navItem" to={"/propRender"}>
            Prop.Render{" "}
          </Link>
          <br />
          <Link className="navItem" to={"/propChildren"}>
            Prop.Children
          </Link>
          <br />
          <Link className="navItem" to={"/codeSplitting"}>
            Prop render with Code Splitting
          </Link>
          <br />
          <Link className="navItem" to={"/reducer"}>
            Reducer
          </Link>
          <br />
          <Link className="navItem" to={"/styledComponent"}>
            Styled Components
          </Link>
        </nav>
        <main>
          ...
          <Route
            path={`/hoc`}
            component={() => <WrappedButton color="red" />}
          />
          <Route path={`/hoc2`} component={WrappedMouse} />
          <Route path={`/hook`} component={Hook_use_State_Effect} />
          <Route path={`/hook2`} component={Hook_Checkbox} />
          ...
          <Route path={`/reducer`} component={Hook_useReducer} />
          {/*in line rendering */}
          {/* <Route
                        path="/githubuser"
                        render={() => (
          ...
          <Route path="/githubuser" render={display}></Route>
          {/* <Route
